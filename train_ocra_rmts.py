...
parser.add_argument('--task', type=str, default='RMTS', help="{'same_diff', 'RMTS', 'dist3', 'identity_rules'}")
parser.add_argument('--train_gen_method', type=str, default='full_space', help="{'full_space', 'subsample'}")
parser.add_argument('--test_gen_method', type=str, default='subsample', help="{'full_space', 'subsample'}")
...
train_data = RMTSdataset(args.path, train_set, args.img_size,args)
# val_data = Dist3dataset(args.path, val_set, args.img_size,args)
test_data = RMTSdataset(args.path, test_set, args.img_size,args)
