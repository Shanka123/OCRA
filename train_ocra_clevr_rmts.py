...
class ClevrARTdataset(Dataset):
	def __init__(self,  root_dir,dataset_type, img_size,args):
		...
		self.alltargets = np.load('RMTS_ood_{}.npz'.format(dataset_type))['y']
...
parser.add_argument('--task', type=str, default='CLEVR_RMTS', help="{'same_diff', 'RMTS', 'dist3', 'identity_rules'}")
...
parser.add_argument('--path', default='output/rmts_images/', type=str, help='dataset path')
